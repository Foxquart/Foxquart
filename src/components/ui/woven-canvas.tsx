...
export const WovenCanvas = ({ className }: { className?: string }) => {
  ...
  useEffect(() => {
    ...
    const torusKnot = new THREE.TorusKnotGeometry(1.85, 0.58, 240, 34);
    ...
    for (let i = 0; i < particleCount; i++) {
        ...
        color.setHSL(Math.random(), 0.88, 0.42);
        colors[i * 3] = color.r;
  ...
  return <div ref={mountRef} className={className ?? "relative h-full w-full overflow-hidden"} />;
};
...
export const WovenLightHero = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-black dark:bg-white">
      <WovenCanvas className="absolute inset-0 z-0 h-full w-full" />
      <HeroNav />
