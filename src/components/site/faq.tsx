 ...
 *
 * Deduplication: a Question must not appear in two `FAQPage` nodes. The 12
 * service FAQs (`/services/$slug`) and 34 solution FAQs (`/solutions/$slug`) are
 * already emitted on their own pages, so none of them is repeated here. These
 * are engagement-level questions asked before a buyer picks a service at all.
 */
const faqs: Array<{ q: string; a: string }> = [
  {
    // custom-software-development-services.faqs["How do you price projects?"];
  ...
  },
  {
    ...
    // custom-software-development-services.outcomes["Two-week delivery increments"].
  ...
  },
  {
    ...
    // custom-software-development-services.outcomes["Documented architecture and full IP transfer"].
  ...
  },
  {
    ...
    a: "Often you shouldn't. If a packaged product fits about 80% of your process, we implement and extend it rather than rebuild it. Custom is the right call when your process, pricing logic or compliance rules break the standard model. Otherwise the gaps get filled with spreadsheets anyway.",
  },
  {
    // custom-software-development-services.outcomes + .problems
  ...
  },
  {
    ...
    // custom-software-development-services.outcomes["Ongoing support and
  ...
  },
  {
    ...
    a: "That is the intended end state. Environments are reproducible infrastructure as code, architecture and automations are documented for handover, and most engagements run jointly with your engineers. We document and train as we go, so nobody inherits a black box.",
  },
  {
    // custom-software-development-services.outcomes["Fixed-scope discovery
    ...
    a: "A fixed-price discovery, and nothing past it. Discovery maps the process, ranks it by hours consumed and feasibility, and produces the scope and cost for delivery; for process automation it runs two weeks. Delivery only starts once you approve that scope.",
  },
];
